...
urlpatterns = [
    ...
    url(r'^(?P<ori>WA[A-Z0-9]{2}[0-9]{3})/$', views.multi_year, name='multi_year'),
    url(r'^(?P<ori>WASPD00)/(?P<year>[0-9]{4})/$', views.single_year, name='single_year'),
    url(r'^(?P<ori>WASPD00)/(?P<crime>[a-z_]+)/$', views.multi_year, name='multi_year'),
